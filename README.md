...
|----------|--------------|-------|
| 🧩 [**Notion Rides**](https://github.com/JhayceeCodes/NotionRides/tree/master/backend/django) | A ride-booking web app with user authentication, notifications, and real-time interactions including reservation and payment. | Django, DRF, PostgreSQL |
